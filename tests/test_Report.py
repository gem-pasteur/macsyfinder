...
class TestHMMReport(TestReport):
    ...
    def test_str(self):
        ...
        hits = [Hit(gene, model, "NC_xxxxx_xx_056141", 803, "NC_xxxxx_xx", 141, float(2e-236), float(779.2),
                    float(1.000000), (741.0 - 104.0 + 1) / 803, 104, 741),
                Hit(gene, model, "PSAE001c01_006940", 803, "PSAE001c01", 68, float(1.2e-234),
                    float(779.2), float(1.000000), (741.0 - 104.0 + 1) / 803, 104, 741),
                Hit(gene, model, "PSAE001c01_013980", 759, "PSAE001c01", 69, float(3.7e-76), float(255.8),
                    float(1.000000), (736.0 - 105.0 + 1) / 759, 105, 736),
                Hit(gene, model, "PSAE001c01_017350", 600, "PSAE001c01", 70, float(3.2e-27), float(94.2),
                    float(0.500000), (506.0 - 226.0 + 1) / 600, 226, 506),
                Hit(gene, model, "PSAE001c01_018920", 776, "PSAE001c01", 71, float(6.1e-183), float(608.4),
                    float(1.000000), (606.0 - 48.0 + 1) / 776, 48, 606),
                Hit(gene, model, "PSAE001c01_031420", 658, "PSAE001c01", 73, float(1.8e-210), float(699.3),
...
#
    def test_best_hit(self):
        ...
        hit_expected = Hit(gene, model, "NC_xxxxx_xx_056141", 803, "NC_xxxxx_xx", 141, float(2e-236), float(779.2),
                           float(1.000000), (741.0 - 104.0 + 1) / 803, 104, 741)
        print()
        print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
        print(best_hit)
...
#                     float(1.000000), (741.0 - 104.0 + 1) / 803, 104, 741),
#                 Hit(gene, system, "PSAE001c01_006940", 803, "Unordered", 68, float(1.2e-234), float(779.2),
#                     float(1.000000), (741.0 - 104.0 + 1) / 803, 104, 741),
#                 Hit(gene, system, "PSAE001c01_013980", 759, "Unordered", 69, float(3.7e-76), float(255.8),
#                     float(1.000000), (736.0 - 105.0 + 1) / 759, 105, 736),
#                 Hit(gene, system, "PSAE001c01_017350", 600, "Unordered", 70, float(3.2e-27), float(94.2),
#                     float(0.500000), (506.0 - 226.0 + 1) / 600,  226, 506),
#                 Hit(gene, system, "PSAE001c01_018920", 776, "Unordered", 71, float(6.1e-183), float(608.4),
#                     float(1.000000), (606.0 - 48.0 + 1) / 776, 48, 606),
#                 Hit(gene, system, "PSAE001c01_031420", 658, "Unordered", 73, float(1.8e-210), float(699.3),
#                     float(1.000000), (614.0 - 55.0 + 1) / 658, 55, 614)
#                 ]
#         self.assertListEqual(hits, report.hits)
#
