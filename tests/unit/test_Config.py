...
class Test(MacsyTest):
    ...
    def test_def_dir(self):
        ...
        self.tearDown()
        def_dir = os.path.normpath(os.path.join(os.path.dirname(__file__), '..', 'data', 'DEF'))
        self.cfg = Config(cfg_file="nimportnaoik",
                          sequence_db=os.path.join(self._data_dir, "base", "test_base.fa"),
                          db_type='gembase',
                          def_dir=def_dir,
    ...
    def test_profile_dir(self):
        ...
        self.assertRaises(ValueError, Config, **kwargs)
        profile_dir = os.path.normpath(os.path.join(os.path.dirname(__file__), '..', 'data', 'profiles'))
        self.cfg = Config(cfg_file="nimportnaoik",
                          sequence_db=os.path.join(self._data_dir, "base", "test_base.fa"),
                          db_type='gembase',
                          def_dir=os.path.join(self._data_dir, 'DEF'),
